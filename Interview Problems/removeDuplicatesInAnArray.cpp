...
Approach
First keeping i at index 0 and looping from j = 1, then if both elements in i and j are same, increase j+1 , if different 
values-then first increase ith element by 1 and put put element of j in ith position, then continue the loop .You will 
understand with the code now
*/
